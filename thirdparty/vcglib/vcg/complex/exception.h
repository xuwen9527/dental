...
public:
  ...
  {
    std::cout << "Node has to be composed by triangle and not polygons -" << err << "- \n";
  }

    virtual const char *what() const throw ()
    {
      static char buf[128]="Node has to be composed by triangle and not polygons";
      return buf;
    }
};
...
public:
  ...
  {
    std::cout << "Node has to be composed by polygonal faces (not plain triangles) -" << err << "- \n";
  }

    virtual const char *what() const throw ()
    {
      static char buf[128]="Node has to be composed by polygonal faces (not plain triangles) ";
      return buf;
    }
};
...
public:
  ...
  {
    std::cout << "Node does not satisfy the following precondition:" << err << "- \n";
  }

    virtual const char *what() const throw ()
    {
      static char buf[128]="Node does not satisfy precondition";
      return buf;
    }
};
